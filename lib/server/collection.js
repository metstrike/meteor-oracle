...
if(Meteor.isServer) {
	...
	Oracle.resetDefaultOracleOptions({
			...
			strict: false, // strict mode, if true prevents automatic modification of db schema
			strictAllowOplogAndTriggers: false, // strict allows creation of oplog table and opllog triggers
			sql: null,
			sqlParameters: [],
			sqlScn: null,
			sqlAddId: false,
